...
The fourth experiment run (table \ref{simple-rnn-repeats-accuracy}) is chosen to dive deeper into the inner workings of the classifier.

TODO: Check whether samples chosen are correctly predicted!

TODO: Add reference to visualization source

TODO: Add flack and backflip neuron visualizations
